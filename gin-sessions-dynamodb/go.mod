module github.com/nguyengg/go-aws-commons/gin-sessions-dynamodb
...
require (
	...
	github.com/nguyengg/go-aws-commons/ddb v0.2.1
...
require (
	...
	github.com/nguyengg/go-aws-commons/lambda v0.1.0 // indirect
